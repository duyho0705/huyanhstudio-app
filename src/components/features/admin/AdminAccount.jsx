  ...
  return (
    <div className="relative p-2">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className={`w-full h-12 px-5 bg-slate-50 border rounded-xl focus:bg-white focus:ring-4 outline-none transition-all font-medium text-slate-900 ${
        ...
        <div className="space-y-2">
          <label className="flex items-center justify-between text-sm font-bold text-slate-700 ml-1">
        ...
        <button 
            ...
            className="w-full h-14 bg-slate-900 disabled:bg-slate-400 text-white rounded-2xl font-black uppercase tracking-[0.1em] text-sm hover:bg-slate-800 active:scale-95 transition-all shadow-xl shadow-slate-200 mt-4 flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
